...
public class NGWriter
{
    ...
    private bool WriteOptionsSection(List<short> allWords, NGScriptData ngData)
    {
        ...
        int flagsHeader = (200 * 256) + 1;  // cnt_FlagsOption * 256 + 1 word
        optionsWords.Add((short)flagsHeader);
    ...
    private void WriteSecurityHeader(List<short> allWords, ScriptData scriptData)
    {
    ...
    private bool WriteLevelSection(List<short> allWords, NGCommandGroup levelCommands, int levelIndex)
    {
        ...
        int flagsHeader = (201 * 256) + 1;  // cnt_FlagsLevel * 256 + 1 word
        levelWords.Add((short)flagsHeader);
    ...
    private bool WriteImportFile(List<short> allWords, NGImportFile importFile)
    {
        int wordCountIndex = allWords.Count;
    ...
    private bool AppendWordsToFile(string filePath, List<short> words)
    {
        try
        {
