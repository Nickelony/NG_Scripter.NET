...
public class ConstantsLoader
{
    ...
    public bool LoadConstants(string constantsFilePath)
    {
        try
        {
            ...
            foreach (var line in lines)
            {
                ...
                string constantName = trimmed.Substring(0, colonIndex).Trim();
    ...
    private bool TryParseConstantValue(string valueStr, out int value)
    {
        ...
        {
            return int.TryParse(valueStr.Substring(1), NumberStyles.HexNumber, null, out value);
        }
        
        // Handle hex values with 0x
        if (valueStr.StartsWith("0X"))
        {
            return int.TryParse(valueStr.Substring(2), NumberStyles.HexNumber, null, out value);
        }
