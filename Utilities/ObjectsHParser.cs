...
public class ObjectsHParser
{
    ...
    private void ParseEnum(string content, string enumName, Dictionary<string, int> targetDict)
    {
        ...
        var lines = enumBody.Split(new[] { '\r', '\n' }, StringSplitOptions.RemoveEmptyEntries);
        ...
        foreach (var line in lines)
        {
            ...
            if (parts.Length > 1)
            {
                ...
                {
                    if (int.TryParse(valueStr.Substring(2), System.Globalization.NumberStyles.HexNumber, null, out int hexValue))
                    {
    ...
    {
        return _slotConstants.TryGetValue(name, out value);
    }
    ...
    {
        return _staticConstants.TryGetValue(name, out value);
    }
