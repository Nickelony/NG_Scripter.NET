...
public static class StringUtilities
{
    ...
    /// </summary>
    public static bool ConvertCStyleToActual(ref string text, out string specialTag, bool forNGStrings = false, bool analyzeMode = false)
    {
        ...
        if (commentIndex >= 0)
        {
            ...
            // Do NOT trim again here to match VB6 behavior which keeps trailing spaces before comments
        }
        ...
        if (!forNGStrings)
        {
            ...
            if (colonIndex > 0)
            {
                ...
                if (!hasSpaces)
                {
                    ...
                    specialTag = text.Substring(0, colonIndex + 1);
    ...
    public static (string command, List<string> arguments) ParseCommandLine(string line)
    {
        ...
        string command = line.Substring(0, equalsIndex + 1).Trim();
        string argsText = line.Substring(equalsIndex + 1).Trim();
